...
public class SubscriptionDaoTest {
    ...
    public void testGetSubscriptionsByUserId() {
        ...
        when(jdbcTemplate.queryForList(anyString(), eq(Subscription.class), eq(user.getId())))
        ...
        verify(jdbcTemplate).queryForList(anyString(), eq(Subscription.class), eq(user.getId()));
    }
}
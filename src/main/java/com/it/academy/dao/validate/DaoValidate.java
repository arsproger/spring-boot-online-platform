...
public class DaoValidate {
    ...
    public void checkCourseExistsById(Long courseId) {
        Boolean check = jdbcTemplate.queryForObject(
    ...
    public void checkLessonExistsById(Long lessonId) {
        Boolean check = jdbcTemplate.queryForObject(
    ...
    public void checkCategoryExistsById(Long categoryId) {
        Boolean check = jdbcTemplate.queryForObject(
    ...
    public void checkSectionExistsById(Long sectionId) {
        Boolean check = jdbcTemplate.queryForObject(

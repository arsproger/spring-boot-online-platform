  ...
  return (
    <footer className={s.footer}>
      ...
      <ul className={s.footer__list}>
        <li>
          <a href="#" className={s.footer__title}>Обучение</a>
        </li>
      ...
      <ul className={s.footer__list}>
        <li>
          <a href="#" className={s.footer__title}>О нас</a>
        </li>
      ...
      <ul className={s.footer__list}>
        <li>
          <a href="#" className={s.footer__title}>Контакты</a>
        </li>
      ...
      <ul className={s.footer__list}>
        <li>
          <a href="#" className={s.footer__title}>Возникли вопросы?</a>
        </li>
